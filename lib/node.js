...
function fetch(options) {
  var store = options.createStore(options.reducers, options.initialState, options.enhancer, options.history);
...
function render(options) {
  return config.render(Object.assign({}, options, {
    ...
    state: Object.assign(options.store.getState(), { routing: {}}),
