...
This will also be used to generate fragment type information in case no [`graphqlSchemaFile`](#graphqlschemafile) has been provided.
...
Read more about GraphQL mocking [here](#graphql-mock-server)
